...
class RepeatedIntervalTest {
    ...
    fun `Should say if it contains a date (weekly repetition)`() {
        val interval = RepeatedInterval.create(DayOfWeek.THURSDAY, "10:00", "12:00")
    ...
    fun `Should say if it contains a interval(no repetition)`() {
        val interval = RepeatedInterval("2019-05-23T10:00:00", "2019-05-23T12:00:00")
        ...
        Assertions.assertThat(interval.contains(Interval("2019-05-23T12:00:01", "2019-05-23T16:00:00"))).isFalse()
    }
    ...
    fun `Should say if it contains a interval (weekly repetition)`() {
        ...
        Assertions.assertThat(interval.contains(Interval("2019-05-23T08:00:00", "2019-05-23T09:59:59"))).isFalse()
        Assertions.assertThat(interval.contains(Interval("2019-05-23T12:00:01", "2019-05-23T16:00:00"))).isFalse()
        Assertions.assertThat(interval.contains(Interval("2019-05-22T10:00:00", "2019-05-22T11:00:00"))).isFalse()
    }

    @Test
    fun `Should say if it contains a interval (monthly repetition)`() {
        val interval = RepeatedInterval("2019-05-23T10:00:00", "2019-05-23T12:00:00", RepetitionType.MONTHLY)
        Assertions.assertThat(interval.contains(Interval("2019-06-23T10:00:00", "2019-06-23T11:00:00"))).isTrue()
        Assertions.assertThat(interval.contains(Interval("2020-06-23T10:00:00", "2020-06-23T11:00:00"))).isTrue()
    }

    @Test
    fun `Should say if it contains a interval (yearly repetition)`() {
        val interval = RepeatedInterval("2019-05-23T10:00:00", "2019-05-23T12:00:00", RepetitionType.YEARLY)
        Assertions.assertThat(interval.contains(Interval("2019-05-23T10:00:00", "2019-05-23T11:00:00"))).isTrue()
        Assertions.assertThat(interval.contains(Interval("2020-05-23T08:00:00", "2020-05-23T11:00:00"))).isFalse()
    }
    ...
    fun `Should not contains a interval if it is beyond the repetition end`() {
        ...
        Assertions.assertThat(interval.contains(Interval("2019-10-09T10:00:00", "2019-10-09T11:00:00"))).isTrue()
        Assertions.assertThat(interval.contains(Interval("2019-10-10T10:00:00", "2019-10-10T11:00:00"))).isFalse()
    }
    ...
    fun `Should not overlaps an interval if it is beyond the repetition end`() {
        ...
        Assertions.assertThat(interval.overlaps(Interval("2019-10-09T08:00:00", "2019-10-09T11:00:00"))).isTrue()
        Assertions.assertThat(interval.overlaps(Interval("2019-10-10T08:00:00", "2019-10-10T11:00:00"))).isFalse()
    }
    ...
    fun `Stress test`() {
        ...
        val result = interval.overlaps(
                Interval(interval.start.plusYears(testYears), interval.end.plusYears(testYears)))

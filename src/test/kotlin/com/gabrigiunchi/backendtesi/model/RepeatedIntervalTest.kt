...
class RepeatedIntervalTest {
    ...
    @Test
    fun `Should say if it contains a zoned date (no repetition)`() {
    ...
    @Test
    fun `Should say if it contains a zoned date (daily repetition)`() {
        val interval = RepeatedInterval("2019-04-23T10:00:00", "2019-04-23T12:00:00", RepetitionType.daily)
        val utc = ZoneId.of("UTC")
        val newYork = ZoneId.of("America/New_York")
    ...
    @Test
    fun `Should say if it contains a zoned date (weekly repetition)`() {
        var interval = RepeatedInterval.create(DayOfWeek.THURSDAY, LocalTime.parse("10:00"), LocalTime.parse("12:00"))
        val utc = ZoneId.of("UTC")
        val newYork = ZoneId.of("America/New_York")
        ...
        // EDGE CASES
        interval = RepeatedInterval.create(DayOfWeek.THURSDAY, LocalTime.parse("00:00"), LocalTime.parse("23:59"))
        Assertions.assertThat(interval.contains(OffsetDateTime.parse("2019-05-22T22:00:00-04:00"), utc)).isTrue()

        interval = RepeatedInterval.create(DayOfWeek.THURSDAY, LocalTime.parse("08:00"), LocalTime.parse("23:59"))
        Assertions.assertThat(interval.contains(OffsetDateTime.parse("2019-05-22T22:00:00-04:00"), utc)).isFalse()
        Assertions.assertThat(interval.contains(OffsetDateTime.parse("2019-05-22T22:00:00-04:00"), newYork)).isFalse()
    }

    @Test
    fun `Should say if it contains a zoned date (monthly repetition)`() {
        val interval = RepeatedInterval("2019-04-23T10:00:00", "2019-04-23T12:00:00", RepetitionType.monthly)
        val utc = ZoneId.of("UTC")
        val newYork = ZoneId.of("America/New_York")
    ...
    @Test
    fun `Should say if it contains a zoned date (yearly repetition)`() {
        val interval = RepeatedInterval("2018-05-23T10:00:00", "2018-05-23T12:00:00", RepetitionType.yearly)
        val utc = ZoneId.of("UTC")
        val newYork = ZoneId.of("America/New_York")
    ...
    @Test
    fun `Should say if it contains a zoned date (weekly repetition and repetition end)`() {
        val interval = RepeatedInterval(
                "2019-05-23T10:00:00",
                "2019-05-23T12:00:00",
                RepetitionType.weekly,
        ...
        // UTC
        Assertions.assertThat(interval.contains(OffsetDateTime.parse("2019-07-11T11:00:00+00:00"), utc)).isTrue()
        Assertions.assertThat(interval.contains(OffsetDateTime.parse("2019-07-18T11:00:00+00:00"), utc)).isFalse()
        Assertions.assertThat(interval.contains(OffsetDateTime.parse("2019-07-25T11:00:00+00:00"), utc)).isFalse()

        // New York
        Assertions.assertThat(interval.contains(OffsetDateTime.parse("2019-07-11T11:00:00-04:00"), newYork)).isTrue()
        Assertions.assertThat(interval.contains(OffsetDateTime.parse("2019-07-18T11:00:00-04:00"), newYork)).isFalse()
        Assertions.assertThat(interval.contains(OffsetDateTime.parse("2019-07-25T11:00:00-04:00"), newYork)).isFalse()
    }
}
